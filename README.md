...
> **Патч-ноут  [1.1.0-alpha] - 2026-04-17**
> ### Added✔️
> - SMTP-провайдер для отправки email-кодов подтверждения
> - Механизм фильтрации номеров по критериям
> - FluentValidation-валидаторы для всех request-моделей

> ### Fixed🛠️
> - Скорректирована логика callback-вызовов в SAGA-оркестраторе: теперь компенсирующие транзакции гарантированно срабатывают при ошибках выполнения шагов
